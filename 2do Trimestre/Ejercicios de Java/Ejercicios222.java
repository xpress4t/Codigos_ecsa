...
public class Ejercicios222 {
	 ...
	 */
		...
		case 7:
			...
			break;	
			default:
			System.out.println("No coincide con ninguno de los días de la semana");
		}
		...
		case "Diciembre":
			...
			break;
			default:
			System.out.println("No coincide con ninguno de los meses del año");
		...
		case 1,2:
			...
			break;
			default:
			System.out.println("No coincide con ninguna de las notas");
		}
