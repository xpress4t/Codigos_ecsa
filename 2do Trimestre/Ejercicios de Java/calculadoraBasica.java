...
public class calculadoraBasica {
	...
	// Función que almacena el menú donde aparecen las opciones a elegir
	// y también donde puedo elegir entre agregar, mostrar, calcular y salir
	...
	// Función para imprimir la lista de números ingresada
	...
	// Función para calcular la suma de todos los números de la lista
	...
	// Función para calcular la resta de todos los números de la lista
	...
	// Función para calcular la multiplicación de todos los números de la lista
	...
	// Función para calcular la división de todos los números de la lista
	...
	// Función para calcular la potencia de todos los números de la lista
