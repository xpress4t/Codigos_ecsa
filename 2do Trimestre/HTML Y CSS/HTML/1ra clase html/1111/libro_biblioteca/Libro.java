...
Crear una clase llamada "Libro"
	Funciones (métodos):
		Constructor: Un constructor que acepte tres parámetros, el título (cadena de caracteres), el autor (cadena de caracteres) y el año de publicación (entero), y los utilice para inicializar los atributos de la clase.
