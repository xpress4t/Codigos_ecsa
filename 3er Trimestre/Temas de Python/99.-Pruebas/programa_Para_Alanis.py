...
class Heart(Frame):
	def __init__(self,master):
		...
		self.chars = ['perfect','incomparable','beautiful','divine','i love you','sweet','gorgeous','darling']
		self.char = 'Alanis'
		self.create_obj()
		self.update()
	...
	def create_obj(self):
		for i in range(200):
			obj = self.canvas.create_text(0,0, font= ('Comic Sans ms',16))
			self.canvas.coords(obj,520,350)
